...
<input type="hidden" name="id" value="<?=$id?>"/>
  ...
  <div class="form-row">
        ...
        <input type="text" class="form-control" id="login" name="login" placeholder="Login" value = "<?=$login?>">
        </div>
        <div class="form-group col-md-4">
  ...
  <a href="cdCliente.php  " class="btn btn-outline-secondary" role="button" aria-pressed="true">Lista de Cadastros</a>
</form>
